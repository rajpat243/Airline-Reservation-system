...
private:
    std::vector<std::string> choices;    // List of choice strings
    int indexChoice;                     // Index of the currently selected choice
    int firstVisibleChoice;              // Index of the first visible choice in the list box
    int visibleItemCount;                // Number of items that can be visible at once
};
