...
// Constructor
ECFlight::ECFlight(const string &srcIn, const string &destIn, double tmDepartIn, int maxPassengersIn) : src(srcIn), dest(destIn), tmDepart(tmDepartIn), maxPassengers(maxPassengersIn)
{}
...
void ECFlight::SetMaxNumPassengers(int m) {maxPassengers = m;}

// Get the source airport code
string ECFlight::GetSource() const {return src;}
