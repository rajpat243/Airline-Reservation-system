...
public:
    ...
    //ECAirlineTicketing() : operation(nullptr) {}
...
private:
    ...
    void DFS(const std::string &currentAirport, const std::string &destination, std::vector<ECFlightItinerary> 
    &itineraries, std::vector<ECFlight*> &currentPath, double lastArrivalTime) const;
