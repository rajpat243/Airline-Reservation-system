...
public:
    ...
    void AddPassengerBudget(const std::string &src, const std::string &dest, int a );

    void AddPassengerBusiness(const std::string &src, const std::string &dest, double a);

    void AddPassengerComfort(const std::string &src, const std::string &dest, double a, double b, int c);
...
private:
    ...
    bool flightAddingDone;
    std::vector<std::function<bool(const ECFlightItinerary&, const ECFlightItinerary&)>> preferences;
};
