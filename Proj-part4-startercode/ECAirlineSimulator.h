...
public:
    ...
    //implement later in part 2
    void PreferLowPrice();//std::vector<ECFlightItinerary> &listItineraries) ;
    void PreferShortTime();//std::vector<ECFlightItinerary> &listItineraries) ;
