...
public:
    ...
    ECConsoleUIButton(int xUL, int yUL, int xLR, int yLR, const string &strButIn, 
                      ECConsoleUIListBox *origin, ECConsoleUIListBox *dest, 
                      ECConsoleUIListBox *flights, ECAirlineTicketing *ticketSys) 
    : ECConsoleUIItem(xUL, yUL, xLR, yLR), strButton(strButIn), originBox(origin), 
      destBox(dest), flightsBox(flights), ticketing(ticketSys) {}
...
private:
    ...
    ECConsoleUIListBox *originBox;  
    ECConsoleUIListBox *destBox;   
    ECAirlineTicketing *ticketing;
    ECConsoleUIListBox *flightsBox; 
};
